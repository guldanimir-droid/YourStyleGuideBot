...
def get_main_keyboard():
    kb = [
        ...
        [KeyboardButton(text="🤔 Что надеть?"), KeyboardButton(text="❓ Помощь")],
        [KeyboardButton(text="🔙 Назад к стилисту")]
    ]
...
async def start(message: Message):
    await message.answer(
        "👋 Привет! Я бот для управления твоим гардеробом.\n\n"
        "Добавляй вещи, смотри гардероб, получай идеи образов.",
...
async def got_description(message: Message, state: FSMContext):
    ...
    bucket_name = "wardrobe"   # убедитесь, что в Supabase Storage бакет называется именно wardrobe
